...
#define CONFIG_SYS_BOOT_FROM_NFSROOT   1

#define CONFIG_SYS_CHIP_COUNT 		1
//#define CONFIG_SYS_EEPROM_AT24C02A 	1
#define CONFIG_SYS_EEPROM_AT24C16A 	1

#define CONFIG_SYS_CPU_SPEED		100000000	/* CPU bootup speed */

#define CONFIG_SYS_EXTAL		3686400	/* EXTAL freq: 12 MHz */
...
#if  CONFIG_SYS_BOOT_FROM_NFSROOT
...
#define CONFIG_SYS_RX_ETH_BUFFER	16	/* use 16 rx buffers on jz4730 eth */
...
#define CONFIG_SYS_FLASH_BASE		PHYS_FLASH_1 /* Flash at 0xbf800000 - 0xbfffffff */
